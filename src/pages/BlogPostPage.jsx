    ...
    return (
      <MarketingShell navigate={navigate} lang={lang} tweaks={tweaks} setTweak={setTweak}>
        <section className="mk-hero">
          <h1 className="mk-hero-title">{L({ uk: "Статтю не знайдено", en: "Article not found", pl: "Nie znaleziono artykułu", de: "Artikel nicht gefunden", ro: "Articolul nu a fost găsit", cs: "Článek nenalezen", sr: "Članak nije pronađen", hu: "A cikk nem található", ar: "المقال غير موجود", es: "Artículo no encontrado", pt: "Artigo não encontrado" })}</h1>
          <p className="mk-hero-sub">
            <a className="mk-auth-link" href="#/blog" onClick={go("/blog")}>{L({ uk: "← До блогу", en: "← Back to blog", pl: "← Wróć do bloga", de: "← Zurück zum Blog", ro: "← Înapoi la blog", cs: "← Zpět na blog", sr: "← Nazad na blog", hu: "← Vissza a bloghoz", ar: "← العودة إلى المدونة", es: "← Volver al blog", pt: "← Voltar ao blogue" })}</a>
          </p>
        </section>
      </MarketingShell>
    );
    ...
    <MarketingShell navigate={navigate} lang={lang} tweaks={tweaks} setTweak={setTweak}>
      <article className="mk-article">
        <a className="mk-auth-back is-top mk-article-back" href="#/blog" onClick={go("/blog")}>
          <Icon name="arrowLeft" size={16} /> {L({ uk: "Блог", en: "Blog", pl: "Blog", de: "Blog", ro: "Blog", cs: "Blog", sr: "Blog", hu: "Blog", ar: "المدونة", es: "Blog", pt: "Blogue" })}
        </a>
      ...
      <section className="mk-section">
        <div className="lp-head"><h2 className="lp-h2">{L({ uk: "Читати далі", en: "Read next", pl: "Czytaj dalej", de: "Weiterlesen", ro: "Citiți în continuare", cs: "Čtěte dále", sr: "Čitajte dalje", hu: "Olvasson tovább", ar: "اقرأ التالي", es: "Siga leyendo", pt: "Leia a seguir" })}</h2></div>
