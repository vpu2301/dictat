// voiceCommands.js — UK + EN + DE vocabulary mirror.
//
...
export const COMMANDS = [
  // intent          op (FE)                    UK phrases / EN phrases / DE phrases
  //
  // German joins the two that were here from sprint 05 because
  // dictation-service accepts it on the wire (LANGUAGE_PATTERN ^(uk|en|de)$)
  // and nlp-service punctuates it (Literal["uk","en","de"], _UNITS_DE). The
  // phrases are lower-cased on both sides of the comparison, which is what
  // makes capitalised German nouns ("Neuer Absatz") match.
  { intent: "newparagraph",   op: "insert_paragraph_break",
    uk: ["новий абзац", "абзац", "новий параграф"],
    en: ["new paragraph", "paragraph break"],
    de: ["neuer absatz", "absatz"] },
  { intent: "newline",        op: "insert_line_break",
    uk: ["новий рядок", "перенос рядка"],
    en: ["new line", "line break"],
    de: ["neue zeile", "zeilenumbruch"] },
  ...
  { intent: "dash",           op: "insert_punctuation", arg: { value: "—", glue: "standalone" },
    uk: ["тире", "довге тире"],
    en: ["dash", "em dash"],
    de: ["gedankenstrich", "langer strich"] },
  ...
  { intent: "ampersand",        op: "insert_punctuation", arg: { value: "&", glue: "standalone" },
    ...
    en: ["ampersand"],
    de: ["kaufmännisches und", "und zeichen"] },
  { intent: "at_sign",          op: "insert_punctuation", arg: { value: "@", glue: "both" },
    uk: ["собачка"],
    en: ["at sign"],
    de: ["at zeichen", "klammeraffe"] },
